...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "PortalWeb@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "PortalWeb API";

        private String description = "PortalWeb API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "PortalWeb";
    ...
    public static class FrigorificosBle {
    	//private String host = "http://192.168.0.7:8080/";
    	private String host = "http://181.48.101.158/";
